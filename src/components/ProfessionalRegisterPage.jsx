    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <p className="text-sm md:text-basetext-lg md:text-2xl text-slate-300">{benefit.description}</p>
            </motion.div>
          ))}
        </div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-green-500/10 to-blue-500/10 p-4 md:p-8 rounded-xl border border-slate-700"
        >
          <h2 className=" md:text-2xl font-semibold mb-6">Register as a Professional</h2>
          <form onSubmit={handleSubmit(onSubmit)} className="md:space-y-6 space-y-4">
            ...
            <div>
              ...
              <select {...register('categoria', {required: 'Subject is required'})} className="w-full px-4 py-2 md:py-3 bg-slate-800 rounded-lg border border-slate-700 focus:border-green-400 focus:outline-none">
